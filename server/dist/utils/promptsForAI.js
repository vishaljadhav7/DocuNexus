...
exports.promptForReviewingContract = exports.promptForContractRecognition = void 0;
const promptForContractRecognition = (contractText) => {
    const prompt = `
...
exports.promptForContractRecognition = promptForContractRecognition;
const promptForReviewingContract = (tier, contractType) => {
    let prompt;
    if (tier === "premium") {
        prompt = `
...
exports.promptForReviewingContract = promptForReviewingContract;
